...
- Skill ID: `distributed-locking-safety`
- SKILL gốc: [skills/distributed-locking-safety/SKILL.md](../../skills/distributed-locking-safety/SKILL.md)
- Agent config: [skills/distributed-locking-safety/agents/openai.yaml](../../skills/distributed-locking-safety/agents/openai.yaml)
- Thư mục references: [skills/distributed-locking-safety/references](../../skills/distributed-locking-safety/references)

## Description / Mô tả

### EN
- Core purpose: Use distributed locks safely under contention.
- Scope of work:
...
Use this skill to review lock semantics, timeouts, and failure behavior.
