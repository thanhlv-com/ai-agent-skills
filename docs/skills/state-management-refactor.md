...
- Skill ID: `state-management-refactor`
- SKILL gốc: [skills/state-management-refactor/SKILL.md](../../skills/state-management-refactor/SKILL.md)
- Agent config: [skills/state-management-refactor/agents/openai.yaml](../../skills/state-management-refactor/agents/openai.yaml)
- Thư mục references: [skills/state-management-refactor/references](../../skills/state-management-refactor/references)

## Description / Mô tả

### EN
- Core purpose: Refactor complex frontend state to predictable patterns.
- Scope of work:
...
Use this skill to simplify state flow and side-effect handling.
