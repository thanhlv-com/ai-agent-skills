...
- Skill ID: `alert-fatigue-reduction`
- SKILL gốc: [skills/alert-fatigue-reduction/SKILL.md](../../skills/alert-fatigue-reduction/SKILL.md)
- Agent config: [skills/alert-fatigue-reduction/agents/openai.yaml](../../skills/alert-fatigue-reduction/agents/openai.yaml)
- Thư mục references: [skills/alert-fatigue-reduction/references](../../skills/alert-fatigue-reduction/references)

## Description / Mô tả

### EN
- Core purpose: Reduce noisy alerts and improve actionable signal.
- Scope of work:
...
Use this skill to refine alert rules, thresholds, and ownership mapping.
