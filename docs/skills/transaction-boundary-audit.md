...
- Skill ID: `transaction-boundary-audit`
- SKILL gốc: [skills/transaction-boundary-audit/SKILL.md](../../skills/transaction-boundary-audit/SKILL.md)
- Agent config: [skills/transaction-boundary-audit/agents/openai.yaml](../../skills/transaction-boundary-audit/agents/openai.yaml)
- Thư mục references: [skills/transaction-boundary-audit/references](../../skills/transaction-boundary-audit/references)

## Description / Mô tả

### EN
- Core purpose: Validate transaction scope and atomicity guarantees.
- Scope of work:
...
Use this skill to audit transaction boundaries and fix partial-write risks.
