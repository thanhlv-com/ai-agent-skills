# Hotfix Workflow Discipline

- Skill ID: `hotfix-workflow-discipline`
- SKILL gốc: [skills/hotfix-workflow-discipline/SKILL.md](../../skills/hotfix-workflow-discipline/SKILL.md)
- Agent config: [skills/hotfix-workflow-discipline/agents/openai.yaml](../../skills/hotfix-workflow-discipline/agents/openai.yaml)
- Thư mục references: [skills/hotfix-workflow-discipline/references](../../skills/hotfix-workflow-discipline/references)

## Description / Mô tả

### EN
- Core purpose: Standardize urgent production fix workflow.
- Scope of work:
...
Use this skill to define safe hotfix flow with traceability and tests.
