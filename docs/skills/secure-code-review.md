...
- SKILL gốc: [skills/secure-code-review/SKILL.md](../../skills/secure-code-review/SKILL.md)
- Agent config: [skills/secure-code-review/agents/openai.yaml](../../skills/secure-code-review/agents/openai.yaml)
- Thư mục references: [skills/secure-code-review/references](../../skills/secure-code-review/references)

## Description / Mô tả

### EN
- Core purpose: Review code changes with a security-first checklist.
- Scope of work:
...
Use this skill to perform targeted secure code review and remediation.
