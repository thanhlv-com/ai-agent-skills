...
- Skill ID: `rollback-readiness`
- SKILL gốc: [skills/rollback-readiness/SKILL.md](../../skills/rollback-readiness/SKILL.md)
- Agent config: [skills/rollback-readiness/agents/openai.yaml](../../skills/rollback-readiness/agents/openai.yaml)
- Thư mục references: [skills/rollback-readiness/references](../../skills/rollback-readiness/references)

## Description / Mô tả

### EN
- Core purpose: Prepare safe rollback procedures for risky changes.
- Scope of work:
...
Use this skill to add rollback plan, checks, and recovery runbook steps.
