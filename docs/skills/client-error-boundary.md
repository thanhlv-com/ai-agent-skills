...
- Skill ID: `client-error-boundary`
- SKILL gốc: [skills/client-error-boundary/SKILL.md](../../skills/client-error-boundary/SKILL.md)
- Agent config: [skills/client-error-boundary/agents/openai.yaml](../../skills/client-error-boundary/agents/openai.yaml)
- Thư mục references: [skills/client-error-boundary/references](../../skills/client-error-boundary/references)

## Description / Mô tả

### EN
- Core purpose: Contain client runtime failures gracefully.
- Scope of work:
...
Use this skill to add error boundaries and fallback UI handling.
