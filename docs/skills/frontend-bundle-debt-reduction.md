# Frontend Bundle Debt Reduction

- Skill ID: `frontend-bundle-debt-reduction`
- SKILL gốc: [skills/frontend-bundle-debt-reduction/SKILL.md](../../skills/frontend-bundle-debt-reduction/SKILL.md)
- Agent config: [skills/frontend-bundle-debt-reduction/agents/openai.yaml](../../skills/frontend-bundle-debt-reduction/agents/openai.yaml)
- Thư mục references: [skills/frontend-bundle-debt-reduction/references](../../skills/frontend-bundle-debt-reduction/references)

## Description / Mô tả

### EN
- Core purpose: Reduce bundle size and loading overhead.
- Scope of work:
...
Use this skill to trim bundle weight and improve code-splitting strategy.
