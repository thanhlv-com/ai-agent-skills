...
- Skill ID: `ci-pipeline-optimization`
- SKILL gốc: [skills/ci-pipeline-optimization/SKILL.md](../../skills/ci-pipeline-optimization/SKILL.md)
- Agent config: [skills/ci-pipeline-optimization/agents/openai.yaml](../../skills/ci-pipeline-optimization/agents/openai.yaml)
- Thư mục references: [skills/ci-pipeline-optimization/references](../../skills/ci-pipeline-optimization/references)

## Description / Mô tả

### EN
- Core purpose: Speed up CI while preserving quality gates.
- Scope of work:
...
Use this skill to optimize pipeline parallelism, caching, and failure visibility.
