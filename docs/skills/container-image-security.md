...
- Skill ID: `container-image-security`
- SKILL gốc: [skills/container-image-security/SKILL.md](../../skills/container-image-security/SKILL.md)
- Agent config: [skills/container-image-security/agents/openai.yaml](../../skills/container-image-security/agents/openai.yaml)
- Thư mục references: [skills/container-image-security/references](../../skills/container-image-security/references)

## Description / Mô tả

### EN
- Core purpose: Secure container images and supply chain inputs.
- Scope of work:
...
Use this skill to harden image build, scan, and runtime policies.
