...
- Skill ID: `modularization-refactor`
- SKILL gốc: [skills/modularization-refactor/SKILL.md](../../skills/modularization-refactor/SKILL.md)
- Agent config: [skills/modularization-refactor/agents/openai.yaml](../../skills/modularization-refactor/agents/openai.yaml)
- Thư mục references: [skills/modularization-refactor/references](../../skills/modularization-refactor/references)

## Description / Mô tả

### EN
- Core purpose: Split oversized modules into cohesive units.
- Scope of work:
...
Use this skill to refactor code into smaller modules with clear responsibilities.
