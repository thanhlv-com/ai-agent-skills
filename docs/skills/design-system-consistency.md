...
- Skill ID: `design-system-consistency`
- SKILL gốc: [skills/design-system-consistency/SKILL.md](../../skills/design-system-consistency/SKILL.md)
- Agent config: [skills/design-system-consistency/agents/openai.yaml](../../skills/design-system-consistency/agents/openai.yaml)
- Thư mục references: [skills/design-system-consistency/references](../../skills/design-system-consistency/references)

## Description / Mô tả

### EN
- Core purpose: Align UI implementation with design system standards.
- Scope of work:
...
Use this skill to standardize components, tokens, and usage patterns.
