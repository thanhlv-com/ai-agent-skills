...
- Skill ID: `input-validation-guard`
- SKILL gốc: [skills/input-validation-guard/SKILL.md](../../skills/input-validation-guard/SKILL.md)
- Agent config: [skills/input-validation-guard/agents/openai.yaml](../../skills/input-validation-guard/agents/openai.yaml)
- Thư mục references: [skills/input-validation-guard/references](../../skills/input-validation-guard/references)

## Description / Mô tả

### EN
- Core purpose: Ensure strict input validation across interfaces.
- Scope of work:
...
Use this skill to add robust validation and negative tests for external inputs.
