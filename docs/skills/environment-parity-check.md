...
- Skill ID: `environment-parity-check`
- SKILL gốc: [skills/environment-parity-check/SKILL.md](../../skills/environment-parity-check/SKILL.md)
- Agent config: [skills/environment-parity-check/agents/openai.yaml](../../skills/environment-parity-check/agents/openai.yaml)
- Thư mục references: [skills/environment-parity-check/references](../../skills/environment-parity-check/references)

## Description / Mô tả

### EN
- Core purpose: Reduce dev/staging/prod environment drift.
- Scope of work:
...
Use this skill to align environment settings and deployment assumptions.
