...
- Skill ID: `event-driven-reliability`
- SKILL gốc: [skills/event-driven-reliability/SKILL.md](../../skills/event-driven-reliability/SKILL.md)
- Agent config: [skills/event-driven-reliability/agents/openai.yaml](../../skills/event-driven-reliability/agents/openai.yaml)
- Thư mục references: [skills/event-driven-reliability/references](../../skills/event-driven-reliability/references)

## Description / Mô tả

### EN
- Core purpose: Improve reliability in event-based workflows.
- Scope of work:
...
Use this skill to harden event publishing/consuming with retries and deduplication.
