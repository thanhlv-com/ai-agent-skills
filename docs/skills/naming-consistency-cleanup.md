...
- Skill ID: `naming-consistency-cleanup`
- SKILL gốc: [skills/naming-consistency-cleanup/SKILL.md](../../skills/naming-consistency-cleanup/SKILL.md)
- Agent config: [skills/naming-consistency-cleanup/agents/openai.yaml](../../skills/naming-consistency-cleanup/agents/openai.yaml)
- Thư mục references: [skills/naming-consistency-cleanup/references](../../skills/naming-consistency-cleanup/references)

## Description / Mô tả

### EN
- Core purpose: Standardize naming across code and APIs.
- Scope of work:
...
Use this skill to normalize naming conventions and remove ambiguity.
