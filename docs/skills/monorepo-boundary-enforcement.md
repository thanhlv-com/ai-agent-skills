...
- Skill ID: `monorepo-boundary-enforcement`
- SKILL gốc: [skills/monorepo-boundary-enforcement/SKILL.md](../../skills/monorepo-boundary-enforcement/SKILL.md)
- Agent config: [skills/monorepo-boundary-enforcement/agents/openai.yaml](../../skills/monorepo-boundary-enforcement/agents/openai.yaml)
- Thư mục references: [skills/monorepo-boundary-enforcement/references](../../skills/monorepo-boundary-enforcement/references)

## Description / Mô tả

### EN
- Core purpose: Keep module boundaries and dependencies clean.
- Scope of work:
...
Use this skill to enforce monorepo dependency rules and ownership constraints.
