...
- Skill ID: `backward-compatibility-gate`
- SKILL gốc: [skills/backward-compatibility-gate/SKILL.md](../../skills/backward-compatibility-gate/SKILL.md)
- Agent config: [skills/backward-compatibility-gate/agents/openai.yaml](../../skills/backward-compatibility-gate/agents/openai.yaml)
- Thư mục references: [skills/backward-compatibility-gate/references](../../skills/backward-compatibility-gate/references)

## Description / Mô tả

### EN
- Core purpose: Prevent breaking changes in stable interfaces.
- Scope of work:
...
Use this skill to add compatibility checks for public contracts.
