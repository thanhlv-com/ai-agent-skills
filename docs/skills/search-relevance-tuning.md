...
- Skill ID: `search-relevance-tuning`
- SKILL gốc: [skills/search-relevance-tuning/SKILL.md](../../skills/search-relevance-tuning/SKILL.md)
- Agent config: [skills/search-relevance-tuning/agents/openai.yaml](../../skills/search-relevance-tuning/agents/openai.yaml)
- Thư mục references: [skills/search-relevance-tuning/references](../../skills/search-relevance-tuning/references)

## Description / Mô tả

### EN
- Core purpose: Improve search quality and ranking relevance.
- Scope of work:
...
Use this skill to adjust search analyzers/scoring with measurable outcomes.
