...
- Skill ID: `trace-context-propagation`
- SKILL gốc: [skills/trace-context-propagation/SKILL.md](../../skills/trace-context-propagation/SKILL.md)
- Agent config: [skills/trace-context-propagation/agents/openai.yaml](../../skills/trace-context-propagation/agents/openai.yaml)
- Thư mục references: [skills/trace-context-propagation/references](../../skills/trace-context-propagation/references)

## Description / Mô tả

### EN
- Core purpose: Ensure tracing context flows across boundaries.
- Scope of work:
...
Use this skill to propagate trace/span context through async and network hops.
