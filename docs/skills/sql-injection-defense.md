...
- Skill ID: `sql-injection-defense`
- SKILL gốc: [skills/sql-injection-defense/SKILL.md](../../skills/sql-injection-defense/SKILL.md)
- Agent config: [skills/sql-injection-defense/agents/openai.yaml](../../skills/sql-injection-defense/agents/openai.yaml)
- Thư mục references: [skills/sql-injection-defense/references](../../skills/sql-injection-defense/references)

## Description / Mô tả

### EN
- Core purpose: Eliminate SQL injection risks in data access code.
- Scope of work:
