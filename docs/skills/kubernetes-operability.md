...
- Skill ID: `kubernetes-operability`
- SKILL gốc: [skills/kubernetes-operability/SKILL.md](../../skills/kubernetes-operability/SKILL.md)
- Agent config: [skills/kubernetes-operability/agents/openai.yaml](../../skills/kubernetes-operability/agents/openai.yaml)
- Thư mục references: [skills/kubernetes-operability/references](../../skills/kubernetes-operability/references)

## Description / Mô tả

### EN
- Core purpose: Improve Kubernetes deployment and runtime operations.
- Scope of work:
...
Use this skill to optimize manifests, probes, resources, and rollout safety.
