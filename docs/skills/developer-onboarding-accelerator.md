...
- Skill ID: `developer-onboarding-accelerator`
- SKILL gốc: [skills/developer-onboarding-accelerator/SKILL.md](../../skills/developer-onboarding-accelerator/SKILL.md)
- Agent config: [skills/developer-onboarding-accelerator/agents/openai.yaml](../../skills/developer-onboarding-accelerator/agents/openai.yaml)
- Thư mục references: [skills/developer-onboarding-accelerator/references](../../skills/developer-onboarding-accelerator/references)

## Description / Mô tả

### EN
- Core purpose: Speed up onboarding with practical learning paths.
- Scope of work:
...
Use this skill to improve onboarding docs, starter tasks, and environment setup.
