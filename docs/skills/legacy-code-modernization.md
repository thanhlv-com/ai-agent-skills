...
- Skill ID: `legacy-code-modernization`
- SKILL gốc: [skills/legacy-code-modernization/SKILL.md](../../skills/legacy-code-modernization/SKILL.md)
- Agent config: [skills/legacy-code-modernization/agents/openai.yaml](../../skills/legacy-code-modernization/agents/openai.yaml)
- Thư mục references: [skills/legacy-code-modernization/references](../../skills/legacy-code-modernization/references)

## Description / Mô tả

### EN
- Core purpose: Modernize legacy areas incrementally and safely.
- Scope of work:
...
Use this skill to plan and execute safe modernization with regression protection.
