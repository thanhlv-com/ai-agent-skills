# Unit Test Gap Closure

- Skill ID: `unit-test-gap-closure`
- SKILL gốc: [skills/unit-test-gap-closure/SKILL.md](../../skills/unit-test-gap-closure/SKILL.md)
- Agent config: [skills/unit-test-gap-closure/agents/openai.yaml](../../skills/unit-test-gap-closure/agents/openai.yaml)
- Thư mục references: [skills/unit-test-gap-closure/references](../../skills/unit-test-gap-closure/references)

## Description / Mô tả

### EN
- Core purpose: Add unit coverage for uncovered logic branches.
- Scope of work:
...
Use this skill to close unit-level coverage gaps for changed behavior.
