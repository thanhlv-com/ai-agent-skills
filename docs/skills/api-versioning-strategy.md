...
- Skill ID: `api-versioning-strategy`
- SKILL gốc: [skills/api-versioning-strategy/SKILL.md](../../skills/api-versioning-strategy/SKILL.md)
- Agent config: [skills/api-versioning-strategy/agents/openai.yaml](../../skills/api-versioning-strategy/agents/openai.yaml)
- Thư mục references: [skills/api-versioning-strategy/references](../../skills/api-versioning-strategy/references)

## Description / Mô tả

### EN
- Core purpose: Manage API version rollout and backward compatibility.
- Scope of work:
...
Use this skill to plan and enforce safe API versioning and deprecation steps.
