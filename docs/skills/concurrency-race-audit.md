...
- Skill ID: `concurrency-race-audit`
- SKILL gốc: [skills/concurrency-race-audit/SKILL.md](../../skills/concurrency-race-audit/SKILL.md)
- Agent config: [skills/concurrency-race-audit/agents/openai.yaml](../../skills/concurrency-race-audit/agents/openai.yaml)
- Thư mục references: [skills/concurrency-race-audit/references](../../skills/concurrency-race-audit/references)

## Description / Mô tả

### EN
- Core purpose: Detect and fix race conditions in shared state.
- Scope of work:
...
Use this skill to add synchronization or redesign to remove race conditions.
