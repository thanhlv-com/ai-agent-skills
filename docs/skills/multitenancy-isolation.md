...
- Skill ID: `multitenancy-isolation`
- SKILL gốc: [skills/multitenancy-isolation/SKILL.md](../../skills/multitenancy-isolation/SKILL.md)
- Agent config: [skills/multitenancy-isolation/agents/openai.yaml](../../skills/multitenancy-isolation/agents/openai.yaml)
- Thư mục references: [skills/multitenancy-isolation/references](../../skills/multitenancy-isolation/references)

## Description / Mô tả

### EN
- Core purpose: Guarantee tenant data and config isolation.
- Scope of work:
...
Use this skill to audit and enforce tenant isolation boundaries.
