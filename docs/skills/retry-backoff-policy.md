...
- Skill ID: `retry-backoff-policy`
- SKILL gốc: [skills/retry-backoff-policy/SKILL.md](../../skills/retry-backoff-policy/SKILL.md)
- Agent config: [skills/retry-backoff-policy/agents/openai.yaml](../../skills/retry-backoff-policy/agents/openai.yaml)
- Thư mục references: [skills/retry-backoff-policy/references](../../skills/retry-backoff-policy/references)

## Description / Mô tả

### EN
- Core purpose: Apply safe retry with exponential backoff and jitter.
- Scope of work:
...
Use this skill to enforce retry policy without causing retry storms.
