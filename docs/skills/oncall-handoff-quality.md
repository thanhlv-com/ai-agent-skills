# Oncall Handoff Quality

- Skill ID: `oncall-handoff-quality`
- SKILL gốc: [skills/oncall-handoff-quality/SKILL.md](../../skills/oncall-handoff-quality/SKILL.md)
- Agent config: [skills/oncall-handoff-quality/agents/openai.yaml](../../skills/oncall-handoff-quality/agents/openai.yaml)
- Thư mục references: [skills/oncall-handoff-quality/references](../../skills/oncall-handoff-quality/references)

## Description / Mô tả

### EN
- Core purpose: Improve quality of on-call handoffs and context.
- Scope of work:
...
Use this skill to create reliable handoff artifacts and escalation clarity.
