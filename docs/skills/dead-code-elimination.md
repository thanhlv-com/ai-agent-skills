...
- Skill ID: `dead-code-elimination`
- SKILL gốc: [skills/dead-code-elimination/SKILL.md](../../skills/dead-code-elimination/SKILL.md)
- Agent config: [skills/dead-code-elimination/agents/openai.yaml](../../skills/dead-code-elimination/agents/openai.yaml)
- Thư mục references: [skills/dead-code-elimination/references](../../skills/dead-code-elimination/references)

## Description / Mô tả

### EN
- Core purpose: Remove unreachable or unused code safely.
- Scope of work:
...
Use this skill to detect and prune dead code with confidence checks.
