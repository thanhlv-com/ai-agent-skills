...
- Skill ID: `integration-test-hardening`
- SKILL gốc: [skills/integration-test-hardening/SKILL.md](../../skills/integration-test-hardening/SKILL.md)
- Agent config: [skills/integration-test-hardening/agents/openai.yaml](../../skills/integration-test-hardening/agents/openai.yaml)
- Thư mục references: [skills/integration-test-hardening/references](../../skills/integration-test-hardening/references)

## Description / Mô tả

### EN
- Core purpose: Strengthen integration tests around service boundaries.
- Scope of work:
...
Use this skill to improve integration coverage and failure diagnostics.
