...
- Skill ID: `i18n-l10n-readiness`
- SKILL gốc: [skills/i18n-l10n-readiness/SKILL.md](../../skills/i18n-l10n-readiness/SKILL.md)
- Agent config: [skills/i18n-l10n-readiness/agents/openai.yaml](../../skills/i18n-l10n-readiness/agents/openai.yaml)
- Thư mục references: [skills/i18n-l10n-readiness/references](../../skills/i18n-l10n-readiness/references)

## Description / Mô tả

### EN
- Core purpose: Prepare UI for localization and translation workflows.
- Scope of work:
...
Use this skill to make strings, formatting, and layout localization-safe.
