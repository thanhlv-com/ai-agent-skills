...
- Skill ID: `semantic-versioning-governance`
- SKILL gốc: [skills/semantic-versioning-governance/SKILL.md](../../skills/semantic-versioning-governance/SKILL.md)
- Agent config: [skills/semantic-versioning-governance/agents/openai.yaml](../../skills/semantic-versioning-governance/agents/openai.yaml)
- Thư mục references: [skills/semantic-versioning-governance/references](../../skills/semantic-versioning-governance/references)

## Description / Mô tả

### EN
- Core purpose: Apply semantic versioning discipline to changes.
- Scope of work:
...
Use this skill to classify changes correctly and enforce versioning policy.
