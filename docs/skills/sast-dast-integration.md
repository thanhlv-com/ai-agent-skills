...
- Skill ID: `sast-dast-integration`
- SKILL gốc: [skills/sast-dast-integration/SKILL.md](../../skills/sast-dast-integration/SKILL.md)
- Agent config: [skills/sast-dast-integration/agents/openai.yaml](../../skills/sast-dast-integration/agents/openai.yaml)
- Thư mục references: [skills/sast-dast-integration/references](../../skills/sast-dast-integration/references)

## Description / Mô tả

### EN
- Core purpose: Integrate static and dynamic security testing.
- Scope of work:
...
Use this skill to wire SAST/DAST into CI with actionable triage flow.
