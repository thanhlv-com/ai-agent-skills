...
- Skill ID: `pair-programming-protocol`
- SKILL gốc: [skills/pair-programming-protocol/SKILL.md](../../skills/pair-programming-protocol/SKILL.md)
- Agent config: [skills/pair-programming-protocol/agents/openai.yaml](../../skills/pair-programming-protocol/agents/openai.yaml)
- Thư mục references: [skills/pair-programming-protocol/references](../../skills/pair-programming-protocol/references)

## Description / Mô tả

### EN
- Core purpose: Use pair programming effectively for complex tasks.
- Scope of work:
...
Use this skill to apply structured pairing sessions with clear outcomes.
