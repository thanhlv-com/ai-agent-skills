...
- Skill ID: `test-data-factory-design`
- SKILL gốc: [skills/test-data-factory-design/SKILL.md](../../skills/test-data-factory-design/SKILL.md)
- Agent config: [skills/test-data-factory-design/agents/openai.yaml](../../skills/test-data-factory-design/agents/openai.yaml)
- Thư mục references: [skills/test-data-factory-design/references](../../skills/test-data-factory-design/references)

## Description / Mô tả

### EN
- Core purpose: Build reusable and deterministic test data factories.
- Scope of work:
...
Use this skill to design test fixtures/builders for readability and reuse.
