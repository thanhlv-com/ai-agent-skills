...
- Skill ID: `requirements-clarification-workflow`
- SKILL gốc: [skills/requirements-clarification-workflow/SKILL.md](../../skills/requirements-clarification-workflow/SKILL.md)
- Agent config: [skills/requirements-clarification-workflow/agents/openai.yaml](../../skills/requirements-clarification-workflow/agents/openai.yaml)
- Thư mục references: [skills/requirements-clarification-workflow/references](../../skills/requirements-clarification-workflow/references)

## Description / Mô tả

### EN
- Core purpose: Reduce ambiguity before implementation starts.
- Scope of work:
...
Use this skill to clarify requirements with assumptions, edge cases, and acceptance criteria.
