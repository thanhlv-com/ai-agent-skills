...
- Skill ID: `database-index-strategy`
- SKILL gốc: [skills/database-index-strategy/SKILL.md](../../skills/database-index-strategy/SKILL.md)
- Agent config: [skills/database-index-strategy/agents/openai.yaml](../../skills/database-index-strategy/agents/openai.yaml)
- Thư mục references: [skills/database-index-strategy/references](../../skills/database-index-strategy/references)

## Description / Mô tả

### EN
- Core purpose: Design and tune database indexing effectively.
- Scope of work:
...
Use this skill to optimize index usage based on real query patterns.
