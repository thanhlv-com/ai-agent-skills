...
- Skill ID: `encryption-key-rotation`
- SKILL gốc: [skills/encryption-key-rotation/SKILL.md](../../skills/encryption-key-rotation/SKILL.md)
- Agent config: [skills/encryption-key-rotation/agents/openai.yaml](../../skills/encryption-key-rotation/agents/openai.yaml)
- Thư mục references: [skills/encryption-key-rotation/references](../../skills/encryption-key-rotation/references)

## Description / Mô tả

### EN
- Core purpose: Implement safe key rotation and crypto hygiene.
- Scope of work:
...
Use this skill to design key rotation workflows and compatibility checks.
