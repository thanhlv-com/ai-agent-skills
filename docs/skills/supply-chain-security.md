...
- Skill ID: `supply-chain-security`
- SKILL gốc: [skills/supply-chain-security/SKILL.md](../../skills/supply-chain-security/SKILL.md)
- Agent config: [skills/supply-chain-security/agents/openai.yaml](../../skills/supply-chain-security/agents/openai.yaml)
- Thư mục references: [skills/supply-chain-security/references](../../skills/supply-chain-security/references)

## Description / Mô tả

### EN
- Core purpose: Reduce software supply chain attack surface.
- Scope of work:
...
Use this skill to implement dependency provenance and integrity safeguards.
