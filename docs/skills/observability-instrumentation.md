...
- Skill ID: `observability-instrumentation`
- SKILL gốc: [skills/observability-instrumentation/SKILL.md](../../skills/observability-instrumentation/SKILL.md)
- Agent config: [skills/observability-instrumentation/agents/openai.yaml](../../skills/observability-instrumentation/agents/openai.yaml)
- Thư mục references: [skills/observability-instrumentation/references](../../skills/observability-instrumentation/references)

## Description / Mô tả

### EN
- Core purpose: Improve metrics, logs, and traces for diagnosability.
- Scope of work:
...
Use this skill to add actionable telemetry on critical paths.
