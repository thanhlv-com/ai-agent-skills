...
- Skill ID: `api-deprecation-governance`
- SKILL gốc: [skills/api-deprecation-governance/SKILL.md](../../skills/api-deprecation-governance/SKILL.md)
- Agent config: [skills/api-deprecation-governance/agents/openai.yaml](../../skills/api-deprecation-governance/agents/openai.yaml)
- Thư mục references: [skills/api-deprecation-governance/references](../../skills/api-deprecation-governance/references)

## Description / Mô tả

### EN
- Core purpose: Manage API deprecation lifecycle safely.
- Scope of work:
...
Use this skill to define deprecation policy, notices, and sunset validation.
