# Incident Postmortem Actionizer

- Skill ID: `incident-postmortem-actionizer`
- SKILL gốc: [skills/incident-postmortem-actionizer/SKILL.md](../../skills/incident-postmortem-actionizer/SKILL.md)
- Agent config: [skills/incident-postmortem-actionizer/agents/openai.yaml](../../skills/incident-postmortem-actionizer/agents/openai.yaml)
- Thư mục references: [skills/incident-postmortem-actionizer/references](../../skills/incident-postmortem-actionizer/references)

## Description / Mô tả

### EN
- Core purpose: Convert incident findings into concrete engineering actions.
- Scope of work:
...
Use this skill to translate postmortem outcomes into tracked code/process tasks.
