...
- Skill ID: `session-management-hardening`
- SKILL gốc: [skills/session-management-hardening/SKILL.md](../../skills/session-management-hardening/SKILL.md)
- Agent config: [skills/session-management-hardening/agents/openai.yaml](../../skills/session-management-hardening/agents/openai.yaml)
- Thư mục references: [skills/session-management-hardening/references](../../skills/session-management-hardening/references)

## Description / Mô tả

### EN
- Core purpose: Strengthen session lifecycle and cookie security.
- Scope of work:
...
Use this skill to secure session handling and invalidation behavior.
