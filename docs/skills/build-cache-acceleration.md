...
- Skill ID: `build-cache-acceleration`
- SKILL gốc: [skills/build-cache-acceleration/SKILL.md](../../skills/build-cache-acceleration/SKILL.md)
- Agent config: [skills/build-cache-acceleration/agents/openai.yaml](../../skills/build-cache-acceleration/agents/openai.yaml)
- Thư mục references: [skills/build-cache-acceleration/references](../../skills/build-cache-acceleration/references)

## Description / Mô tả

### EN
- Core purpose: Speed builds with effective cache strategies.
- Scope of work:
...
Use this skill to configure cache keys and layers for reliable acceleration.
