...
- Skill ID: `timeout-budgeting`
- SKILL gốc: [skills/timeout-budgeting/SKILL.md](../../skills/timeout-budgeting/SKILL.md)
- Agent config: [skills/timeout-budgeting/agents/openai.yaml](../../skills/timeout-budgeting/agents/openai.yaml)
- Thư mục references: [skills/timeout-budgeting/references](../../skills/timeout-budgeting/references)

## Description / Mô tả

### EN
- Core purpose: Set coherent timeouts across service boundaries.
- Scope of work:
...
Use this skill to define and align timeout budgets end-to-end.
