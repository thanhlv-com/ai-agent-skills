...
- Skill ID: `nplus1-query-elimination`
- SKILL gốc: [skills/nplus1-query-elimination/SKILL.md](../../skills/nplus1-query-elimination/SKILL.md)
- Agent config: [skills/nplus1-query-elimination/agents/openai.yaml](../../skills/nplus1-query-elimination/agents/openai.yaml)
- Thư mục references: [skills/nplus1-query-elimination/references](../../skills/nplus1-query-elimination/references)

## Description / Mô tả

### EN
- Core purpose: Detect and remove N+1 query patterns.
- Scope of work:
...
Use this skill to refactor data access to eliminate repetitive query amplification.
