...
- Skill ID: `backup-restore-validation`
- SKILL gốc: [skills/backup-restore-validation/SKILL.md](../../skills/backup-restore-validation/SKILL.md)
- Agent config: [skills/backup-restore-validation/agents/openai.yaml](../../skills/backup-restore-validation/agents/openai.yaml)
- Thư mục references: [skills/backup-restore-validation/references](../../skills/backup-restore-validation/references)

## Description / Mô tả

### EN
- Core purpose: Validate backup and restoration reliability.
- Scope of work:
...
Use this skill to test restore procedures and recovery objectives.
