...
- Skill ID: `structured-logging-upgrade`
- SKILL gốc: [skills/structured-logging-upgrade/SKILL.md](../../skills/structured-logging-upgrade/SKILL.md)
- Agent config: [skills/structured-logging-upgrade/agents/openai.yaml](../../skills/structured-logging-upgrade/agents/openai.yaml)
- Thư mục references: [skills/structured-logging-upgrade/references](../../skills/structured-logging-upgrade/references)

## Description / Mô tả

### EN
- Core purpose: Adopt consistent structured logging conventions.
- Scope of work:
...
Use this skill to standardize log schema and context propagation.
