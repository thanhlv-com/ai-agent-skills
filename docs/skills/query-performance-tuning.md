...
- Skill ID: `query-performance-tuning`
- SKILL gốc: [skills/query-performance-tuning/SKILL.md](../../skills/query-performance-tuning/SKILL.md)
- Agent config: [skills/query-performance-tuning/agents/openai.yaml](../../skills/query-performance-tuning/agents/openai.yaml)
- Thư mục references: [skills/query-performance-tuning/references](../../skills/query-performance-tuning/references)

## Description / Mô tả

### EN
- Core purpose: Optimize slow queries and reduce database load.
- Scope of work:
...
Use this skill to profile and optimize query paths with measurable improvements.
