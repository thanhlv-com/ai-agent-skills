...
- Skill ID: `chaos-engineering-safety`
- SKILL gốc: [skills/chaos-engineering-safety/SKILL.md](../../skills/chaos-engineering-safety/SKILL.md)
- Agent config: [skills/chaos-engineering-safety/agents/openai.yaml](../../skills/chaos-engineering-safety/agents/openai.yaml)
- Thư mục references: [skills/chaos-engineering-safety/references](../../skills/chaos-engineering-safety/references)

## Description / Mô tả

### EN
- Core purpose: Run controlled resilience experiments safely.
- Scope of work:
...
Use this skill to design guarded chaos experiments and learning loops.
