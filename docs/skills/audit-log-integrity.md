...
- Skill ID: `audit-log-integrity`
- SKILL gốc: [skills/audit-log-integrity/SKILL.md](../../skills/audit-log-integrity/SKILL.md)
- Agent config: [skills/audit-log-integrity/agents/openai.yaml](../../skills/audit-log-integrity/agents/openai.yaml)
- Thư mục references: [skills/audit-log-integrity/references](../../skills/audit-log-integrity/references)

## Description / Mô tả

### EN
- Core purpose: Ensure audit logs are complete and tamper-evident.
- Scope of work:
...
Use this skill to enforce auditable security events and integrity safeguards.
