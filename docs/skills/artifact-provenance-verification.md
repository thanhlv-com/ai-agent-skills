...
- Skill ID: `artifact-provenance-verification`
- SKILL gốc: [skills/artifact-provenance-verification/SKILL.md](../../skills/artifact-provenance-verification/SKILL.md)
- Agent config: [skills/artifact-provenance-verification/agents/openai.yaml](../../skills/artifact-provenance-verification/agents/openai.yaml)
- Thư mục references: [skills/artifact-provenance-verification/references](../../skills/artifact-provenance-verification/references)

## Description / Mô tả

### EN
- Core purpose: Ensure trusted build artifact provenance.
- Scope of work:
...
Use this skill to add provenance/signature verification in delivery pipeline.
