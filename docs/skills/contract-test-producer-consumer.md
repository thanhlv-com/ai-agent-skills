...
- Skill ID: `contract-test-producer-consumer`
- SKILL gốc: [skills/contract-test-producer-consumer/SKILL.md](../../skills/contract-test-producer-consumer/SKILL.md)
- Agent config: [skills/contract-test-producer-consumer/agents/openai.yaml](../../skills/contract-test-producer-consumer/agents/openai.yaml)
- Thư mục references: [skills/contract-test-producer-consumer/references](../../skills/contract-test-producer-consumer/references)

## Description / Mô tả

### EN
- Core purpose: Keep producer-consumer contracts synchronized.
- Scope of work:
...
Use this skill to implement contract tests to prevent integration drift.
