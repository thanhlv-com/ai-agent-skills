...
- Skill ID: `browser-compatibility-audit`
- SKILL gốc: [skills/browser-compatibility-audit/SKILL.md](../../skills/browser-compatibility-audit/SKILL.md)
- Agent config: [skills/browser-compatibility-audit/agents/openai.yaml](../../skills/browser-compatibility-audit/agents/openai.yaml)
- Thư mục references: [skills/browser-compatibility-audit/references](../../skills/browser-compatibility-audit/references)

## Description / Mô tả

### EN
- Core purpose: Verify behavior across supported browsers.
- Scope of work:
...
Use this skill to address cross-browser inconsistencies and polyfill gaps.
