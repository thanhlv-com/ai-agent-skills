...
- Skill ID: `technical-debt-prioritization`
- SKILL gốc: [skills/technical-debt-prioritization/SKILL.md](../../skills/technical-debt-prioritization/SKILL.md)
- Agent config: [skills/technical-debt-prioritization/agents/openai.yaml](../../skills/technical-debt-prioritization/agents/openai.yaml)
- Thư mục references: [skills/technical-debt-prioritization/references](../../skills/technical-debt-prioritization/references)

## Description / Mô tả

### EN
- Core purpose: Rank and plan debt reduction work by impact.
- Scope of work:
...
Use this skill to prioritize debt items with measurable engineering value.
