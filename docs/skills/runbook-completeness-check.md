...
- Skill ID: `runbook-completeness-check`
- SKILL gốc: [skills/runbook-completeness-check/SKILL.md](../../skills/runbook-completeness-check/SKILL.md)
- Agent config: [skills/runbook-completeness-check/agents/openai.yaml](../../skills/runbook-completeness-check/agents/openai.yaml)
- Thư mục references: [skills/runbook-completeness-check/references](../../skills/runbook-completeness-check/references)

## Description / Mô tả

### EN
- Core purpose: Ensure operational runbooks are complete and testable.
- Scope of work:
...
Use this skill to fill runbook gaps and verify step-by-step recovery flow.
