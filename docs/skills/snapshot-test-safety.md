# Snapshot Test Safety

- Skill ID: `snapshot-test-safety`
- SKILL gốc: [skills/snapshot-test-safety/SKILL.md](../../skills/snapshot-test-safety/SKILL.md)
- Agent config: [skills/snapshot-test-safety/agents/openai.yaml](../../skills/snapshot-test-safety/agents/openai.yaml)
- Thư mục references: [skills/snapshot-test-safety/references](../../skills/snapshot-test-safety/references)

## Description / Mô tả

### EN
- Core purpose: Use snapshot tests safely without brittle approvals.
- Scope of work:
...
Use this skill to scope and curate snapshot usage to avoid false confidence.
