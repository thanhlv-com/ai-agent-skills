...
- Skill ID: `cache-coherency-check`
- SKILL gốc: [skills/cache-coherency-check/SKILL.md](../../skills/cache-coherency-check/SKILL.md)
- Agent config: [skills/cache-coherency-check/agents/openai.yaml](../../skills/cache-coherency-check/agents/openai.yaml)
- Thư mục references: [skills/cache-coherency-check/references](../../skills/cache-coherency-check/references)

## Description / Mô tả

### EN
- Core purpose: Keep cache invalidation and data freshness correct.
- Scope of work:
...
Use this skill to audit cache update/invalidation flow to prevent stale reads.
