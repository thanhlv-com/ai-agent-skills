...
- Skill ID: `cost-optimization-engineering`
- SKILL gốc: [skills/cost-optimization-engineering/SKILL.md](../../skills/cost-optimization-engineering/SKILL.md)
- Agent config: [skills/cost-optimization-engineering/agents/openai.yaml](../../skills/cost-optimization-engineering/agents/openai.yaml)
- Thư mục references: [skills/cost-optimization-engineering/references](../../skills/cost-optimization-engineering/references)

## Description / Mô tả

### EN
- Core purpose: Reduce infra and runtime costs without regressions.
- Scope of work:
...
Use this skill to identify cost hotspots and implement efficient alternatives.
