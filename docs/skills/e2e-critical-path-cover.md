# E2E Critical Path Cover

- Skill ID: `e2e-critical-path-cover`
- SKILL gốc: [skills/e2e-critical-path-cover/SKILL.md](../../skills/e2e-critical-path-cover/SKILL.md)
- Agent config: [skills/e2e-critical-path-cover/agents/openai.yaml](../../skills/e2e-critical-path-cover/agents/openai.yaml)
- Thư mục references: [skills/e2e-critical-path-cover/references](../../skills/e2e-critical-path-cover/references)

## Description / Mô tả

### EN
- Core purpose: Cover critical business flows with E2E tests.
- Scope of work:
...
Use this skill to add and maintain E2E tests for top user journeys.
