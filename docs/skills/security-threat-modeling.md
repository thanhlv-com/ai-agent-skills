...
- SKILL gốc: [skills/security-threat-modeling/SKILL.md](../../skills/security-threat-modeling/SKILL.md)
- Agent config: [skills/security-threat-modeling/agents/openai.yaml](../../skills/security-threat-modeling/agents/openai.yaml)
- Thư mục references: [skills/security-threat-modeling/references](../../skills/security-threat-modeling/references)

## Description / Mô tả

### EN
- Core purpose: Model threats and prioritize security controls.
- Scope of work:
...
Use this skill to run lightweight threat modeling and map mitigations.
