...
- Skill ID: `canary-release-strategy`
- SKILL gốc: [skills/canary-release-strategy/SKILL.md](../../skills/canary-release-strategy/SKILL.md)
- Agent config: [skills/canary-release-strategy/agents/openai.yaml](../../skills/canary-release-strategy/agents/openai.yaml)
- Thư mục references: [skills/canary-release-strategy/references](../../skills/canary-release-strategy/references)

## Description / Mô tả

### EN
- Core purpose: Roll out changes progressively with canary analysis.
- Scope of work:
...
Use this skill to implement canary rollout and automated rollback criteria.
