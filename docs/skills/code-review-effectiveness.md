...
- Skill ID: `code-review-effectiveness`
- SKILL gốc: [skills/code-review-effectiveness/SKILL.md](../../skills/code-review-effectiveness/SKILL.md)
- Agent config: [skills/code-review-effectiveness/agents/openai.yaml](../../skills/code-review-effectiveness/agents/openai.yaml)
- Thư mục references: [skills/code-review-effectiveness/references](../../skills/code-review-effectiveness/references)

## Description / Mô tả

### EN
- Core purpose: Improve code review quality and turnaround.
- Scope of work:
...
Use this skill to enforce high-signal review checklist and feedback standards.
