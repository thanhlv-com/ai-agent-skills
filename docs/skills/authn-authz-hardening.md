...
- Skill ID: `authn-authz-hardening`
- SKILL gốc: [skills/authn-authz-hardening/SKILL.md](../../skills/authn-authz-hardening/SKILL.md)
- Agent config: [skills/authn-authz-hardening/agents/openai.yaml](../../skills/authn-authz-hardening/agents/openai.yaml)
- Thư mục references: [skills/authn-authz-hardening/references](../../skills/authn-authz-hardening/references)

## Description / Mô tả

### EN
- Core purpose: Strengthen authentication and authorization controls.
- Scope of work:
...
Use this skill to review and harden authn/authz flows and permission checks.
