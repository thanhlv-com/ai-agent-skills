...
- Skill ID: `rate-limit-protection`
- SKILL gốc: [skills/rate-limit-protection/SKILL.md](../../skills/rate-limit-protection/SKILL.md)
- Agent config: [skills/rate-limit-protection/agents/openai.yaml](../../skills/rate-limit-protection/agents/openai.yaml)
- Thư mục references: [skills/rate-limit-protection/references](../../skills/rate-limit-protection/references)

## Description / Mô tả

### EN
- Core purpose: Implement and verify API throttling policies.
- Scope of work:
...
Use this skill to add and validate rate limiting and abuse protection behavior.
