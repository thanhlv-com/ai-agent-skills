...
- Skill ID: `api-contract-validation`
- SKILL gốc: [skills/api-contract-validation/SKILL.md](../../skills/api-contract-validation/SKILL.md)
- Agent config: [skills/api-contract-validation/agents/openai.yaml](../../skills/api-contract-validation/agents/openai.yaml)
- Thư mục references: [skills/api-contract-validation/references](../../skills/api-contract-validation/references)

## Description / Mô tả

### EN
- Core purpose: Validate API request/response contracts and prevent schema drift.
- Scope of work:
...
Use this skill to validate API schemas and align handlers with contract definitions.
