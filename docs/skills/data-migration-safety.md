...
- Skill ID: `data-migration-safety`
- SKILL gốc: [skills/data-migration-safety/SKILL.md](../../skills/data-migration-safety/SKILL.md)
- Agent config: [skills/data-migration-safety/agents/openai.yaml](../../skills/data-migration-safety/agents/openai.yaml)
- Thư mục references: [skills/data-migration-safety/references](../../skills/data-migration-safety/references)

## Description / Mô tả

### EN
- Core purpose: Design reversible and safe schema/data migrations.
- Scope of work:
...
Use this skill to create forward/backward-safe migrations and validation checks.
