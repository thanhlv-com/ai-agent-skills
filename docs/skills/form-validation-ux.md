...
- Skill ID: `form-validation-ux`
- SKILL gốc: [skills/form-validation-ux/SKILL.md](../../skills/form-validation-ux/SKILL.md)
- Agent config: [skills/form-validation-ux/agents/openai.yaml](../../skills/form-validation-ux/agents/openai.yaml)
- Thư mục references: [skills/form-validation-ux/references](../../skills/form-validation-ux/references)

## Description / Mô tả

### EN
- Core purpose: Improve form validation clarity and usability.
- Scope of work:
...
Use this skill to implement user-friendly client/server validation behavior.
