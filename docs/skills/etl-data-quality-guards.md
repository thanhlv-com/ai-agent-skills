# ETL Data Quality Guards

- Skill ID: `etl-data-quality-guards`
- SKILL gốc: [skills/etl-data-quality-guards/SKILL.md](../../skills/etl-data-quality-guards/SKILL.md)
- Agent config: [skills/etl-data-quality-guards/agents/openai.yaml](../../skills/etl-data-quality-guards/agents/openai.yaml)
- Thư mục references: [skills/etl-data-quality-guards/references](../../skills/etl-data-quality-guards/references)

## Description / Mô tả

### EN
- Core purpose: Add validation guards to ETL pipelines.
- Scope of work:
...
Use this skill to enforce data quality checks and anomaly detection.
