...
- Skill ID: `stream-processing-correctness`
- SKILL gốc: [skills/stream-processing-correctness/SKILL.md](../../skills/stream-processing-correctness/SKILL.md)
- Agent config: [skills/stream-processing-correctness/agents/openai.yaml](../../skills/stream-processing-correctness/agents/openai.yaml)
- Thư mục references: [skills/stream-processing-correctness/references](../../skills/stream-processing-correctness/references)

## Description / Mô tả

### EN
- Core purpose: Verify correctness in stream processing logic.
- Scope of work:
...
Use this skill to test ordering, windowing, and exactly-once semantics.
