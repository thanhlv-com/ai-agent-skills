...
- Skill ID: `schema-evolution-playbook`
- SKILL gốc: [skills/schema-evolution-playbook/SKILL.md](../../skills/schema-evolution-playbook/SKILL.md)
- Agent config: [skills/schema-evolution-playbook/agents/openai.yaml](../../skills/schema-evolution-playbook/agents/openai.yaml)
- Thư mục references: [skills/schema-evolution-playbook/references](../../skills/schema-evolution-playbook/references)

## Description / Mô tả

### EN
- Core purpose: Evolve schemas without service disruption.
- Scope of work:
...
Use this skill to plan additive/compatible schema changes and rollout.
