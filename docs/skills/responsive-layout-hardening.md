...
- Skill ID: `responsive-layout-hardening`
- SKILL gốc: [skills/responsive-layout-hardening/SKILL.md](../../skills/responsive-layout-hardening/SKILL.md)
- Agent config: [skills/responsive-layout-hardening/agents/openai.yaml](../../skills/responsive-layout-hardening/agents/openai.yaml)
- Thư mục references: [skills/responsive-layout-hardening/references](../../skills/responsive-layout-hardening/references)

## Description / Mô tả

### EN
- Core purpose: Fix layout behavior across breakpoints and devices.
- Scope of work:
...
Use this skill to improve responsive behavior and overflow resilience.
