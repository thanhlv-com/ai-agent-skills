# Test Flakiness Eradication

- Skill ID: `test-flakiness-eradication`
- SKILL gốc: [skills/test-flakiness-eradication/SKILL.md](../../skills/test-flakiness-eradication/SKILL.md)
- Agent config: [skills/test-flakiness-eradication/agents/openai.yaml](../../skills/test-flakiness-eradication/agents/openai.yaml)
- Thư mục references: [skills/test-flakiness-eradication/references](../../skills/test-flakiness-eradication/references)

## Description / Mô tả

### EN
- Core purpose: Find and remove flaky test behavior.
- Scope of work:
...
Use this skill to stabilize tests with deterministic data/time/isolation controls.
