...
- Skill ID: `frontend-performance-budget`
- SKILL gốc: [skills/frontend-performance-budget/SKILL.md](../../skills/frontend-performance-budget/SKILL.md)
- Agent config: [skills/frontend-performance-budget/agents/openai.yaml](../../skills/frontend-performance-budget/agents/openai.yaml)
- Thư mục references: [skills/frontend-performance-budget/references](../../skills/frontend-performance-budget/references)

## Description / Mô tả

### EN
- Core purpose: Enforce performance budgets for web UX.
- Scope of work:
...
Use this skill to optimize frontend assets and runtime performance budgets.
