...
- Skill ID: `service-slo-alignment`
- SKILL gốc: [skills/service-slo-alignment/SKILL.md](../../skills/service-slo-alignment/SKILL.md)
- Agent config: [skills/service-slo-alignment/agents/openai.yaml](../../skills/service-slo-alignment/agents/openai.yaml)
- Thư mục references: [skills/service-slo-alignment/references](../../skills/service-slo-alignment/references)

## Description / Mô tả

### EN
- Core purpose: Align implementation with service SLO/SLI targets.
- Scope of work:
...
Use this skill to map code paths to SLO risk and mitigation actions.
