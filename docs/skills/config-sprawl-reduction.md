# Config Sprawl Reduction

- Skill ID: `config-sprawl-reduction`
- SKILL gốc: [skills/config-sprawl-reduction/SKILL.md](../../skills/config-sprawl-reduction/SKILL.md)
- Agent config: [skills/config-sprawl-reduction/agents/openai.yaml](../../skills/config-sprawl-reduction/agents/openai.yaml)
- Thư mục references: [skills/config-sprawl-reduction/references](../../skills/config-sprawl-reduction/references)

## Description / Mô tả

### EN
- Core purpose: Consolidate and validate fragmented configuration.
- Scope of work:
...
Use this skill to reduce config duplication and clarify override precedence.
