...
- Skill ID: `idempotency-enforcement`
- SKILL gốc: [skills/idempotency-enforcement/SKILL.md](../../skills/idempotency-enforcement/SKILL.md)
- Agent config: [skills/idempotency-enforcement/agents/openai.yaml](../../skills/idempotency-enforcement/agents/openai.yaml)
- Thư mục references: [skills/idempotency-enforcement/references](../../skills/idempotency-enforcement/references)

## Description / Mô tả

### EN
- Core purpose: Add idempotency guarantees for retry-prone operations.
- Scope of work:
...
Use this skill to implement and verify idempotent behavior for write operations.
