...
- Skill ID: `message-queue-resilience`
- SKILL gốc: [skills/message-queue-resilience/SKILL.md](../../skills/message-queue-resilience/SKILL.md)
- Agent config: [skills/message-queue-resilience/agents/openai.yaml](../../skills/message-queue-resilience/agents/openai.yaml)
- Thư mục references: [skills/message-queue-resilience/references](../../skills/message-queue-resilience/references)

## Description / Mô tả

### EN
- Core purpose: Handle queue retries, poison messages, and dead letters.
- Scope of work:
