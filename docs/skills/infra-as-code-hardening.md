...
- Skill ID: `infra-as-code-hardening`
- SKILL gốc: [skills/infra-as-code-hardening/SKILL.md](../../skills/infra-as-code-hardening/SKILL.md)
- Agent config: [skills/infra-as-code-hardening/agents/openai.yaml](../../skills/infra-as-code-hardening/agents/openai.yaml)
- Thư mục references: [skills/infra-as-code-hardening/references](../../skills/infra-as-code-hardening/references)

## Description / Mô tả

### EN
- Core purpose: Improve IaC safety and repeatability.
- Scope of work:
...
Use this skill to harden IaC modules with validation and policy checks.
