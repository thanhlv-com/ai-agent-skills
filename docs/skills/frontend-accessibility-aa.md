# Frontend Accessibility AA

- Skill ID: `frontend-accessibility-aa`
- SKILL gốc: [skills/frontend-accessibility-aa/SKILL.md](../../skills/frontend-accessibility-aa/SKILL.md)
- Agent config: [skills/frontend-accessibility-aa/agents/openai.yaml](../../skills/frontend-accessibility-aa/agents/openai.yaml)
- Thư mục references: [skills/frontend-accessibility-aa/references](../../skills/frontend-accessibility-aa/references)

## Description / Mô tả

### EN
- Core purpose: Meet WCAG AA accessibility requirements.
- Scope of work:
...
Use this skill to fix accessibility issues with semantic and keyboard support.
