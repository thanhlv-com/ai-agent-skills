...
- Skill ID: `xss-csrf-protection`
- SKILL gốc: [skills/xss-csrf-protection/SKILL.md](../../skills/xss-csrf-protection/SKILL.md)
- Agent config: [skills/xss-csrf-protection/agents/openai.yaml](../../skills/xss-csrf-protection/agents/openai.yaml)
- Thư mục references: [skills/xss-csrf-protection/references](../../skills/xss-csrf-protection/references)

## Description / Mô tả

### EN
- Core purpose: Protect applications from XSS and CSRF attacks.
- Scope of work:
...
Use this skill to apply encoding, token, and policy defenses with tests.
