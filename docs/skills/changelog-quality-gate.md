...
- Skill ID: `changelog-quality-gate`
- SKILL gốc: [skills/changelog-quality-gate/SKILL.md](../../skills/changelog-quality-gate/SKILL.md)
- Agent config: [skills/changelog-quality-gate/agents/openai.yaml](../../skills/changelog-quality-gate/agents/openai.yaml)
- Thư mục references: [skills/changelog-quality-gate/references](../../skills/changelog-quality-gate/references)

## Description / Mô tả

### EN
- Core purpose: Improve release notes quality and completeness.
- Scope of work:
...
Use this skill to enforce changelog entries with user-facing impact summary.
