...
- Skill ID: `rbac-policy-sync`
- SKILL gốc: [skills/rbac-policy-sync/SKILL.md](../../skills/rbac-policy-sync/SKILL.md)
- Agent config: [skills/rbac-policy-sync/agents/openai.yaml](../../skills/rbac-policy-sync/agents/openai.yaml)
- Thư mục references: [skills/rbac-policy-sync/references](../../skills/rbac-policy-sync/references)

## Description / Mô tả

### EN
- Core purpose: Keep role-permission mappings consistent with product rules.
- Scope of work:
...
Use this skill to synchronize RBAC rules with implementation and tests.
