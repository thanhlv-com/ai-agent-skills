...
- Skill ID: `batch-job-reliability`
- SKILL gốc: [skills/batch-job-reliability/SKILL.md](../../skills/batch-job-reliability/SKILL.md)
- Agent config: [skills/batch-job-reliability/agents/openai.yaml](../../skills/batch-job-reliability/agents/openai.yaml)
- Thư mục references: [skills/batch-job-reliability/references](../../skills/batch-job-reliability/references)

## Description / Mô tả

### EN
- Core purpose: Make scheduled/batch jobs resilient and observable.
- Scope of work:
...
Use this skill to harden batch execution with idempotency and retries.
