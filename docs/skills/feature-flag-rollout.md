...
- Skill ID: `feature-flag-rollout`
- SKILL gốc: [skills/feature-flag-rollout/SKILL.md](../../skills/feature-flag-rollout/SKILL.md)
- Agent config: [skills/feature-flag-rollout/agents/openai.yaml](../../skills/feature-flag-rollout/agents/openai.yaml)
- Thư mục references: [skills/feature-flag-rollout/references](../../skills/feature-flag-rollout/references)

## Description / Mô tả

### EN
- Core purpose: Safely release features with flags and guardrails.
- Scope of work:
...
Use this skill to implement staged feature-flag rollout and fallback paths.
