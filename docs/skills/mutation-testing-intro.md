...
- Skill ID: `mutation-testing-intro`
- SKILL gốc: [skills/mutation-testing-intro/SKILL.md](../../skills/mutation-testing-intro/SKILL.md)
- Agent config: [skills/mutation-testing-intro/agents/openai.yaml](../../skills/mutation-testing-intro/agents/openai.yaml)
- Thư mục references: [skills/mutation-testing-intro/references](../../skills/mutation-testing-intro/references)

## Description / Mô tả

### EN
- Core purpose: Use mutation testing to assess assertion strength.
- Scope of work:
...
Use this skill to apply mutation checks and strengthen weak tests.
