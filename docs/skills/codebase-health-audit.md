...
- Skill ID: `codebase-health-audit`
- SKILL gốc: [skills/codebase-health-audit/SKILL.md](../../skills/codebase-health-audit/SKILL.md)
- Agent config: [skills/codebase-health-audit/agents/openai.yaml](../../skills/codebase-health-audit/agents/openai.yaml)
- Thư mục references: [skills/codebase-health-audit/references](../../skills/codebase-health-audit/references)

## Description / Mô tả

### EN
- Core purpose: Assess maintainability risks across the codebase.
- Scope of work:
...
Use this skill to identify hotspots and define remediation actions.
