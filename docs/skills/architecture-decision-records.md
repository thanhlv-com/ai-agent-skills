...
- Skill ID: `architecture-decision-records`
- SKILL gốc: [skills/architecture-decision-records/SKILL.md](../../skills/architecture-decision-records/SKILL.md)
- Agent config: [skills/architecture-decision-records/agents/openai.yaml](../../skills/architecture-decision-records/agents/openai.yaml)
- Thư mục references: [skills/architecture-decision-records/references](../../skills/architecture-decision-records/references)

## Description / Mô tả

### EN
- Core purpose: Capture architecture decisions and rationale clearly.
- Scope of work:
...
Use this skill to write ADRs with context, options, and consequences.
