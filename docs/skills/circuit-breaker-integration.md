...
- Skill ID: `circuit-breaker-integration`
- SKILL gốc: [skills/circuit-breaker-integration/SKILL.md](../../skills/circuit-breaker-integration/SKILL.md)
- Agent config: [skills/circuit-breaker-integration/agents/openai.yaml](../../skills/circuit-breaker-integration/agents/openai.yaml)
- Thư mục references: [skills/circuit-breaker-integration/references](../../skills/circuit-breaker-integration/references)

## Description / Mô tả

### EN
- Core purpose: Protect services from cascading downstream failures.
- Scope of work:
...
Use this skill to add circuit breakers and verify fallback behavior.
