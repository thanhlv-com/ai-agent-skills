...
- Skill ID: `error-handling-standardization`
- SKILL gốc: [skills/error-handling-standardization/SKILL.md](../../skills/error-handling-standardization/SKILL.md)
- Agent config: [skills/error-handling-standardization/agents/openai.yaml](../../skills/error-handling-standardization/agents/openai.yaml)
- Thư mục references: [skills/error-handling-standardization/references](../../skills/error-handling-standardization/references)

## Description / Mô tả

### EN
- Core purpose: Standardize error codes, messages, and failure semantics.
- Scope of work:
...
Use this skill to normalize error handling paths and contract-level error responses.
