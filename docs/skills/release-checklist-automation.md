...
- Skill ID: `release-checklist-automation`
- SKILL gốc: [skills/release-checklist-automation/SKILL.md](../../skills/release-checklist-automation/SKILL.md)
- Agent config: [skills/release-checklist-automation/agents/openai.yaml](../../skills/release-checklist-automation/agents/openai.yaml)
- Thư mục references: [skills/release-checklist-automation/references](../../skills/release-checklist-automation/references)

## Description / Mô tả

### EN
- Core purpose: Automate repetitive release verification tasks.
- Scope of work:
...
Use this skill to codify release gates and automate checklist execution.
