...
- Skill ID: `pagination-consistency`
- SKILL gốc: [skills/pagination-consistency/SKILL.md](../../skills/pagination-consistency/SKILL.md)
- Agent config: [skills/pagination-consistency/agents/openai.yaml](../../skills/pagination-consistency/agents/openai.yaml)
- Thư mục references: [skills/pagination-consistency/references](../../skills/pagination-consistency/references)

## Description / Mô tả

### EN
- Core purpose: Ensure stable and predictable pagination behavior.
- Scope of work:
...
Use this skill to standardize pagination semantics and edge-case handling.
